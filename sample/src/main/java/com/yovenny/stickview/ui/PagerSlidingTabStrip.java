...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public void setTitles(String[] titles, OnTabChangeListener onTabChangeListener) {
        mOnTabChangeListener = onTabChangeListener;
        mTitles = titles;
        notifyDataSetChanged();
    }

    public boolean isPagerRefer() {
        return pager != null;
    }
